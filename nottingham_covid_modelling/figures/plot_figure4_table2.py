...
for i, model_i in enumerate(Model_name): 
    ...
    if i<5:
        ...
        filename = get_file_name_suffix_anymodel(p, 'SimSItD-1', '_rho_0-2', 'NBphi_2e-3_', model_i , params_opt_names[model_i+'_fixEta'])
...
burn_in = [25000, 25000, 25000, 1000000, 3000000, 2000000]
thinning_factor = 10
params_opt_names = {}
for i, model_i in enumerate(Model_name): 
    p.eta = 0.1923
